...
namespace Yanyana.BackEnd.Api.Test
{
    ...
    public class CategoriesControllerTests
    {
        ...
        public async Task PostCategory_ValidCategory_ReturnsCreated()
        {
            ...
            Assert.Equal("New Description", returnedCategory.Description);
        }
        ...
        {
            // Arrange
            var updatedCategory = new Category { CategoryId = 1, Name = "Updated Name", Description = "Updated Description" };
            _mockCategoryManager.Setup(m => m.UpdateCategoryAsync(It.IsAny<Category>()))
